...
\begin{enumerate}
  ...
  \item (\texttt{START: 0x02, LENGTH: 2 byte}): \textit{Sequence Number} 
...
\fbox{\parbox{\textwidth}{
\begin{enumerate}
  \item (\texttt{START: 0x00, LENGTH: 2 byte}): \textit{Sequence Number} 
...
\fbox{\parbox{\textwidth}{
\begin{enumerate}
  \item (\texttt{START: 0x00, LENGTH: 1}): \textit{Request Type}; It is MANDATORY. Using this field determines type of request.
