...
tools\xxd -i abstractServiceByteArray > .\java\templates\byte_arrays\abstractService.h
...
tools\xxd -i requestHandlerByteArray > .\java\templates\byte_arrays\requestHandler.h
...
tools\xxd -i serviceProxyBuilderByteArray > .\java\templates\byte_arrays\serviceProxyBuilder.h
...
tools\xxd -i serviceProxyByteArray > .\java\templates\byte_arrays\serviceProxy.h
...
tools\xxd -i serviceByteArray > .\java\templates\byte_arrays\service.h
...
tools\xxd -i structByteArray > .\java\templates\byte_arrays\struct.h
del structByteArray
...
tools\xxd -i serializableStructListByteArray > .\java\templates\byte_arrays\serializableStructList.h
...
tools\xxd -i clientMainByteArray > .\java\templates\byte_arrays\clientMain.h
...
tools\xxd -i serverMainByteArray > .\java\templates\byte_arrays\serverMain.h
...
tools\xxd -i serverImplByteArray > .\java\templates\byte_arrays\serverImpl.h
...
tools\xxd -i enumByteArray > .\java\templates\byte_arrays\enum.h
del enumByteArray
...
tools\xxd -i pomByteArray > .\java\templates\byte_arrays\pom.h
del pomByteArray
