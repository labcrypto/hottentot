 ...
 * Name: person_authenticator_service_proxy.cc
 * Description:
...
namespace proxy {
  void
  PersonAuthenticatorServiceProxy::GetName(
    ...
    request.SetServiceId(2433072731);
    request.SetMethodId(2935213856);
    ...
    /*
     * Serialization of argument 'age'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument age ..." << std::endl;
    }
    serializedData = age.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "age is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);

    /*
     * Serialization of argument 'percent'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument percent ..." << std::endl;
    }
    serializedData = percent.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "percent is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);
  ...
  void
  PersonAuthenticatorServiceProxy::GetNames(
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(2433072731);
    request.SetMethodId(1784602084);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
    ...
    unsigned char *serializedData = 0;
    /*
     * Serialization of argument 'predicate'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument predicate ..." << std::endl;
    }
    serializedData = predicate.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "predicate is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);
  ...
  void
  PersonAuthenticatorServiceProxy::GetG(
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(2433072731);
    request.SetMethodId(2472013022);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
