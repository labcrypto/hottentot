...
namespace proxy {
  ...
  TechServiceProxy::Report(
    ...
    request.SetServiceId(3424918921);
    request.SetMethodId(3912715844);
  ...
  TechServiceProxy::GetSerial(
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(3424918921);
    request.SetMethodId(2183351020);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
