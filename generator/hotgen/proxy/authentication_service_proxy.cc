 ...
 * Name: authentication_service_proxy.cc
 * Description:
...
namespace proxy {
  void
  AuthenticationServiceProxy::Authenticate(
    ...
    request.SetServiceId(3709056755);
    request.SetMethodId(740620036);
    ...
    /*
     * Serialization of argument 'datetime'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument datetime ..." << std::endl;
    }
    serializedData = datetime.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "datetime is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);
