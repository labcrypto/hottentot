 ...
 * Name: phone_manager_service_proxy.cc
 * Description:
...
namespace proxy {
  void
  PhoneManagerServiceProxy::GetPhonebook(
    ...
    request.SetServiceId(1831722476);
    request.SetMethodId(133025501);
  ...
  void
  PhoneManagerServiceProxy::AddEntry(
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(1831722476);
    request.SetMethodId(1769151897);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
    ...
    /*
     * Serialization of argument 'person'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument person ..." << std::endl;
    }
    serializedData = person.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "person is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);

    /*
     * Serialization of argument 'phone'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument phone ..." << std::endl;
    }
    serializedData = phone.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "phone is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);

    /*
     * Serialization of argument 'd'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument d ..." << std::endl;
    }
    serializedData = d.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "d is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);
  ...
  PhoneManagerServiceProxy::FFF(
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(1831722476);
    request.SetMethodId(2372717956);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
    ...
    unsigned char *serializedData = 0;
    /*
     * Serialization of argument 'abc'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument abc ..." << std::endl;
    }
    serializedData = abc.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "abc is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);
