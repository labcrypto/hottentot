 ...
 * Name: token.cc
 * Description:
 *   This file contains implementation of Token class.
 ******************************************************************/
...
namespace hotgen {
  unsigned char *
  Token::Serialize(uint32_t *length_ptr) {
    ...
    uint32_t length1 = 0;
    unsigned char *data1 = id_.Serialize(&length1);
    totalLength += length1;
  ...
  void
  Token::Deserialize(unsigned char *data, uint32_t length) {
