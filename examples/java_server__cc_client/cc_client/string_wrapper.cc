 ...
 * Name: string_wrapper.cc
 * Description:
 *   This file contains implementation of StringWrapper class.
 ******************************************************************/
...
namespace hotgen {
  unsigned char *
  StringWrapper::Serialize(uint32_t *length_ptr) {
  ...
  void
  StringWrapper::Deserialize(unsigned char *data, uint32_t length) {
