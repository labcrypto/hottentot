...
public class TestServiceProxy extends AbstractTestService implements Proxy {
  ...
  public List<Token> auth(Credential credential) { 
    ...
    request.setServiceId(3840930520L);
    request.setMethodId(3860892363L);
  ...
  public List<DataWrapper> test() { 
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(2066849401L);
  ...
  public List<StringWrapper> test2() { 
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(2719924681L);
    request.setArgumentCount((byte) 0);
    request.setType(Request.RequestType.InvokeStateless);
    int dataLength = 0;
    //calculate data length for every argument
  ...
  public StringWrapper test3() { 
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(3413469625L);
    request.setArgumentCount((byte) 0);
    request.setType(Request.RequestType.InvokeStateless);
    int dataLength = 0;
    //calculate data length for every argument
  ...
  public DataWrapper test4() { 
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(3943078220L);
    request.setArgumentCount((byte) 0);
    request.setType(Request.RequestType.InvokeStateless);
    int dataLength = 0;
    //calculate data length for every argument
...
byte[] serializedInputList = serializableStringWrapperList.serialize();
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(3893264993L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
...
byte[] serializedInputs = serializableDataWrapperList.serialize();
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(3743195557L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
  ...
  public SampleStruct test7() { 
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(944580077L);
    request.setArgumentCount((byte) 0);
    request.setType(Request.RequestType.InvokeStateless);
    int dataLength = 0;
    //calculate data length for every argument
    ...
    //deserialize SampleStructpart from response
    SampleStruct sampleStruct= null;
    if (response.getStatusCode() == -1) {
      //TODO
    }
    sampleStruct= new SampleStruct();
    sampleStruct.deserialize(response.getData());
    return sampleStruct;
  }
  public StringWrapper test8(StringWrapper str) { 
    ...
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(3742699770L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
  ...
  public Result test9(SampleStruct sample) { 
    //serialize sample
    byte[] serializedSample = sample.serialize();

    //make request
    Request request = new Request();
    request.setServiceId(3840930520L);
    request.setMethodId(539315280L);
    request.setArgumentCount((byte) 1);
    request.setType(Request.RequestType.InvokeStateless);
    Argument arg0 = new Argument();
    arg0.setDataLength(serializedSample.length);
    arg0.setData(serializedSample);
    request.addArgument(arg0);
    int dataLength = 0;
    //calculate data length for every argument
    //calulate sampleDataLength
    int sampleDataLength= serializedSample.length;
    int sampleDataLengthByteArrayLength = 1;
    if (sampleDataLength >= 0x80) {
      if (sampleDataLength <= 0xff) {
        //ex 0x81 0xff
        sampleDataLengthByteArrayLength = 2;
      } else if (sampleDataLength <= 0xffff) {
        //ex 0x82 0xff 0xff
        sampleDataLengthByteArrayLength = 3;
      } else if (sampleDataLength <= 0xffffff) {
        //ex 0x83 0xff 0xff 0xff
        sampleDataLengthByteArrayLength = 4;
      }
    }
    dataLength += sampleDataLength + sampleDataLengthByteArrayLength;
    //arg count(1) + request type(1) + method ID(4) + service ID(4) = 10;
    request.setLength(10 + dataLength);
    //connect to server
    TcpClient tcpClient = TcpClientFactory.create();
