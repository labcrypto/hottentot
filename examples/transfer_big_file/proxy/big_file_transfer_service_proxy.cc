 ...
 * Name: big_file_transfer_service_proxy.cc
 * Description:
...
namespace proxy {
  void
  BigFileTransferServiceProxy::SendBigFile(
    ...
    request.SetServiceId(160625231);
    request.SetMethodId(361284543);
    ...
    /*
     * Serialization of argument 'fileData'
     */
    serializedDataLength = 0;
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " <<
          "Serializing argument fileData ..." << std::endl;
    }
    serializedData = fileData.Serialize(&serializedDataLength);
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " <<
          "fileData is serialized." << std::endl;
    }
    ...
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " <<
          "Serializing argument fileName ..." << std::endl;
    }
    serializedData = fileName.Serialize(&serializedDataLength);
    if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
      ::org::labcrypto::hottentot::runtime::Logger::GetOut() << 
        "[" << ::org::labcrypto::hottentot::runtime::Utils::GetCurrentUTCTimeString() << "]: " <<
          "fileName is serialized." << std::endl;
    }
    request.AddArgument(serializedData, serializedDataLength);
