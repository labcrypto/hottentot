 ...
 * Name: calculator_service_server.cc
 * Description:
...
main(int argc, char **argv) {
  try {
    ...
    ::ir::ntnaeem::hottentot::examples::calc::CalculatorServiceImpl *service =
        new ::ir::ntnaeem::hottentot::examples::calc::CalculatorServiceImpl;
