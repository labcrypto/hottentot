...
namespace proxy {
  ...
  CalculatorServiceProxy::Add(::naeem::hottentot::runtime::types::UInt16 a, ::naeem::hottentot::runtime::types::UInt16 b) {
    /*
     * Make request object
     */
     ...
     */
    ::naeem::hottentot::runtime::types::UInt16 returnObject;
...
::naeem::hottentot::runtime::types::Int16
  CalculatorServiceProxy::Mul(::naeem::hottentot::runtime::types::Int16 a, ::naeem::hottentot::runtime::types::Int16 b) {
    /*
     * Make request object
     */
    ::naeem::hottentot::runtime::Logger::GetOut() << "Making request object ..." << std::endl;
     ...
     * Response deserialization
     */
    ::naeem::hottentot::runtime::types::Int16 returnObject;
    ::naeem::hottentot::runtime::Utils::PrintArray("Response", protocol->GetResponse()->GetData(), protocol->GetResponse()->GetDataLength());
    returnObject.Deserialize(protocol->GetResponse()->GetData(), protocol->GetResponse()->GetDataLength());
    /*
     * Finalization
