...
public class AuthServiceProxy extends AbstractAuthService implements Proxy {
  ...
  public SerializableList<Token> auth(Credential credential) { 
    ...
    SerializableList<Token> tokenList= null;
    if (response.getStatusCode() == -1) {
      //TODO
    }
    tokenList= new SerializableList<Token>();
    tokenList.deserialize(response.getData());
    return tokenList;
  }
