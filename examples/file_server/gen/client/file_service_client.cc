...
main(int argc, char **argv) {
  try {
    ...
    ::naeem::hottentot::runtime::types::Utf8String fileName = "adasd";
    ::naeem::hottentot::runtime::types::Boolean result;
    proxy->FileExists(fileName, result);
    std::cout << result.GetValue() << std::endl;
    ::naeem::hottentot::runtime::types::ByteArray result2;
    proxy->DownloadFile(fileName, result2);
    for (uint16_t i = 0; i < result2.GetLength(); i++) {
      std::cout << ">>>> " << result2.GetValue()[i] << std::endl;
    }
