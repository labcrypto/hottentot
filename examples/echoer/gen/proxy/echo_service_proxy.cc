...
namespace proxy {
  void
  EchoServiceProxy::EchoMessage(::ir::ntnaeem::hottentot::examples::echoer::RequestMessage &req, ::ir::ntnaeem::hottentot::examples::echoer::ResponseMessage &out) {
    /*
     * Make request object
     */
    ...
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ...
      ::naeem::hottentot::runtime::Utils::PrintArray("req", serializedData, serializedDataLength);
    }
