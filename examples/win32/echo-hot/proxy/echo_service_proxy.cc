...
namespace proxy {
  void
  EchoServiceProxy::DoEcho(::ir::ntnaeem::hottentot::examples::win32::echo::EchoRequest &req, ::ir::ntnaeem::hottentot::examples::win32::echo::EchoResponse &out) {
    /*
     * Make request object
     */
    ...
    request.SetServiceId(3814922490);
    request.SetMethodId(165906122);
